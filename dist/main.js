...
function Header() {
  let [expanded, setExpanded] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
  let [toggled, setToggled] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
  const onClick = () => {
    if (!toggled) {
      setToggled(true);
    }
...
function Main() {
  const ref = react__WEBPACK_IMPORTED_MODULE_0__.useRef();
  const initedRef = react__WEBPACK_IMPORTED_MODULE_0__.useRef(false);
  const [activeTab, setActiveTab] = react__WEBPACK_IMPORTED_MODULE_0__.useState("");
  const [hasRightScroll, setHasRightScroll] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
  ...
  const onSelectInput = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(event => {
    setActiveTab(event.target.value);
  }, []);
  let sizes = [];
  const onSize = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(size => {
    sizes = [...sizes, size];
  }, [sizes]);
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
  ...
  }, TABS_KEYS.map(key => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("option", {
    key: key,
    value: key
  }, TABS[key].title))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", {
    role: "tablist",
    className: "section__tabs"
  }, TABS_KEYS.map(key => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
    key: key,
    role: "tab",
  ...
  }, TABS[key].title)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "section__panel-wrapper",
    ref: ref
  }, TABS_KEYS.map(key => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    key: key,
    role: "tabpanel",
  ...
  }, TABS[key].items.map((item, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Event, _extends({
    key: index
  }, item, {
    onSize: onSize
